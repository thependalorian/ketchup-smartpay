...
export class DistributionEngine {
   ...
   */
  async distributeToBuffr(voucher: Voucher, beneficiary?: Beneficiary | null): Promise<DistributionResult> {
    try {
   ...
   */
  async confirmDelivery(voucherId: string, deliveryId: string): Promise<void> {
