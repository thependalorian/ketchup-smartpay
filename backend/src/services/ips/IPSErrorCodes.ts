...
export const IPS_REJECTION_REASONS: Record<string, IPSErrorResponse> = {
  INSUFFICIENT_FUNDS: {
    status: 'RJCT',
...
export function toIPSError(code: keyof typeof IPS_REJECTION_REASONS, additionalInfo?: string): IPSErrorResponse {
