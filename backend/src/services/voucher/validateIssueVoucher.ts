...
export function validateIssueVoucherDTO(data: unknown): { ok: true; data: IssueVoucherDTO } | { ok: false; error: string } {
  ...
  if (!VOUCHER_GRANT_TYPES.includes(grantTypeTrimmed as any)) {
  ...
  let scheduledIssueAt: string | undefined;
  ...
  let buffrUserId: string | undefined;
