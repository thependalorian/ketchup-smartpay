 ...
 */
router.get('/monthly', authenticate, async (req: Request, res: Response<APIResponse<any>>) => {
  try {
 ...
 */
router.get('/voucher-distribution', authenticate, async (req: Request, res: Response<APIResponse<any>>) => {
  try {
 ...
 */
router.get('/redemption-analytics', authenticate, async (req: Request, res: Response<APIResponse<any>>) => {
  try {
    const month = req.query.month as string;
 ...
 */
router.get('/agent-network', authenticate, async (req: Request, res: Response<APIResponse<any>>) => {
  try {
    const month = req.query.month as string;
