...
import { BeneficiaryFilters, CreateBeneficiaryDTO, UpdateBeneficiaryDTO, CreateDependantDTO, UpdateDependantDTO } from '../../../../../shared/types';
...
router.get('/', async (req: Request, res: Response<APIResponse<any>>) => {
  try {
    const filters: BeneficiaryFilters = {
      ...
      grantType: req.query.grantType as any,
 ...
 */
router.get('/:id/vouchers', authenticate, async (req: Request, res: Response<APIResponse<any>>) => {
  try {
    const { id } = req.params;
 ...
 */
router.get('/:id/dependants', async (req: Request, res: Response<APIResponse<any>>) => {
  try {
    const { id } = req.params;
 ...
 */
router.post('/:id/dependants', async (req: Request, res: Response<APIResponse<any>>) => {
  try {
    const { id } = req.params;
    const data: CreateDependantDTO = req.body;
 ...
 */
router.get('/:id/dependants/:dependantId', async (req: Request, res: Response<APIResponse<any>>) => {
  try {
 ...
 * Update a dependant
 */
router.patch('/:id/dependants/:dependantId', async (req: Request, res: Response<APIResponse<any>>) => {
  try {
    const { id, dependantId } = req.params;
    const data: UpdateDependantDTO = req.body;
 ...
 * Delete a dependant
 */
router.delete('/:id/dependants/:dependantId', async (req: Request, res: Response<APIResponse<any>>) => {
  try {
    const { id, dependantId } = req.params;
...
router.post('/', async (req: Request, res: Response<APIResponse<any>>) => {
  try {
    const data: CreateBeneficiaryDTO = req.body;
...
router.put('/:id', async (req: Request, res: Response<APIResponse<any>>) => {
  try {
    const { id } = req.params;
    const data: UpdateBeneficiaryDTO = req.body;
