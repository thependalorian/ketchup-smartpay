...
export type WebhookEventType = 'voucher.redeemed' | 'voucher.expired' | 'voucher.delivered' | 'voucher.cancelled' | 'voucher.failed_delivery';
...
export type ReportType = 'voucher_summary' | 'redemption_analysis' | 'regional_distribution' | 'agent_performance' | 'compliance_audit';
...
export type AuditAction = 'create' | 'read' | 'update' | 'delete' | 'login' | 'logout' | 'export' | 'permission_change';
