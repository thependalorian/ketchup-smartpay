...
import { validateTakeDownNotice, executeTakeDownFlow, processInputErrorWithdrawal, } from '../../../services/eta/ETAService';
 ...
 */
router.post('/trust-account/reconcile', authenticateAPIKey, async (req, res) => {
    try {
 ...
 */
router.get('/trust-account/status', authenticateAPIKey, async (req, res) => {
    try {
 ...
 */
router.get('/trust-account/history', authenticateAPIKey, async (req, res) => {
    try {
 ...
 */
router.post('/2fa/generate', authenticateAPIKey, async (req, res) => {
    try {
 ...
 * Validate OTP
 */
router.post('/2fa/validate', authenticateAPIKey, async (req, res) => {
    try {
 ...
 */
router.get('/2fa/verify/:transactionId', authenticateAPIKey, async (req, res) => {
    try {
 ...
 */
router.get('/uptime/status', authenticateAPIKey, async (req, res) => {
    try {
 ...
 */
router.post('/uptime/monitor', authenticateAPIKey, async (req, res) => {
    try {
 ...
 */
router.post('/incidents/detect', authenticateAPIKey, async (req, res) => {
    try {
 ...
 */
router.post('/incidents/:incidentId/report-bon', authenticateAPIKey, async (req, res) => {
    try {
 ...
 */
router.post('/incidents/:incidentId/impact-assessment', authenticateAPIKey, async (req, res) => {
    try {
        const { incidentId } = req.params;
 ...
 * Get open incidents
 */
router.get('/incidents/open', authenticateAPIKey, async (req, res) => {
    try {
 ...
 */
router.post('/dormant-wallets/check', authenticateAPIKey, async (req, res) => {
    try {
 ...
 * Get dormant wallets
 */
router.get('/dormant-wallets', authenticateAPIKey, async (req, res) => {
    try {
 ...
 */
router.get('/dormant-wallets/statistics', authenticateAPIKey, async (req, res) => {
    try {
 ...
 */
router.post('/capital/track', authenticateAPIKey, async (req, res) => {
    try {
        ...
        const report = await CapitalRequirementsService.trackDailyCapital(liquidAssets, initialCapitalHeld);
        res.json({
            success: true,
            data: report,
 ...
 */
router.get('/capital/status', authenticateAPIKey, async (req, res) => {
    try {
 ...
 */
router.post('/bon-reports/generate', authenticateAPIKey, async (req, res) => {
    try {
 ...
 */
router.post('/bon-reports/:reportId/submit', authenticateAPIKey, async (req, res) => {
    try {
 ...
 * Get pending reports
 */
router.get('/bon-reports/pending', authenticateAPIKey, async (req, res) => {
    try {
 ...
 */
router.get('/bon-reports/:reportId/export', authenticateAPIKey, async (req, res) => {
    try {
        const { reportId } = req.params;
...
router.get('/dashboard', authenticateAPIKey, async (req, res) => {
    try {
        ...
        const [trustAccountStatus, capitalStatus, uptimeStatus, openIncidents, pendingReports, dormancyStats,] = await Promise.all([
 ...
 */
router.get('/audit-trail', authenticateAPIKey, async (req, res) => {
    try {
...
router.post('/eta/take-down', authenticateAPIKey, async (req, res) => {
    try {
        ...
        const result = await executeTakeDownFlow(notice, async (materialId) => { void materialId; }, async (materialId) => `contact-${materialId}`, async (_contactId, _materialId) => { }, async (_materialId, _reason) => { }, async (_materialId, _info) => { }, async () => false);
...
router.post('/eta/input-error-withdrawal', authenticateAPIKey, async (req, res) => {
    try {
        ...
        const refundPayment = async (txId) => { void txId; };
        const cancelContract = async (txId) => { void txId; };
