 ...
 */
router.get('/:id/float', authenticate, async (req, res) => {
    try {
        const { id } = req.params;
 ...
 * Top up agent float
 */
router.post('/:id/float/topup', authenticate, async (req, res) => {
    try {
        const { id } = req.params;
 ...
 */
router.post('/:id/float/withdraw', authenticate, async (req, res) => {
    try {
        const { id } = req.params;
 ...
 */
router.get('/performance/rankings', authenticate, async (req, res) => {
    try {
        const type = req.query.type;
 ...
 */
router.get('/liquidity/alerts', authenticate, async (req, res) => {
    try {
        const threshold = req.query.threshold ? parseFloat(req.query.threshold) : 1.5;
