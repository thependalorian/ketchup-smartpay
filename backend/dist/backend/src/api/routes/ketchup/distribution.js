...
router.post('/batch', async (req, res) => {
    try {
        ...
        const vouchers = await Promise.all(voucherIds.map(id => voucherService.getById(id)));
        ...
        const getBeneficiary = (beneficiaryId) => beneficiaryService.getById(beneficiaryId);
