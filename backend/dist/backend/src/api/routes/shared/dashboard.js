 ...
 */
router.get('/monthly-trend', authenticate, asyncHandler(async (req, res) => {
    try {
 ...
 */
router.get('/redemption-channels', authenticate, asyncHandler(async (req, res) => {
    try {
 ...
 */
router.get('/regional-stats', authenticate, asyncHandler(async (req, res) => {
    try {
 ...
 */
router.get('/requires-attention', authenticate, asyncHandler(async (req, res) => {
    try {
        const days = req.query.expiringWithinDays ? parseInt(req.query.expiringWithinDays, 10) : 7;
