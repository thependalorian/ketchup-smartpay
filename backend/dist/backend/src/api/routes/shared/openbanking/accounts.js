 ...
 */
router.get('/accounts', requireScope('banking:accounts.basic.read'), async (req, res) => {
    try {
 ...
 * Required Scope: banking:accounts.basic.read
 */
router.get('/accounts/:accountId/balance', requireScope('banking:accounts.basic.read'), async (req, res) => {
    try {
 ...
 * Required Scope: banking:accounts.basic.read
 */
router.get('/accounts/:accountId/transactions', requireScope('banking:accounts.basic.read'), async (req, res) => {
    try {
        const { accountId } = req.params;
        ...
        const result = await aisService.listTransactions(accountId, fromDate, toDate, page, pageSize);
