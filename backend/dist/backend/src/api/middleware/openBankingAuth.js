 ...
 * - x-v: 1 (API version)
 */
export async function authenticateOpenBanking(req, res, next) {
    try {
        ...
        const apiVersion = req.headers['x-v'];
        if (!apiVersion) {
            res.status(400).json({
                errors: [{
 ...
 */
export async function logAPIAccess(req, res, next) {
...
//# sourceMappingURL=openBankingAuth.js.map