...
export class ComplianceScheduler {
    static dailyReconciliationInterval = null;
    static uptimeMonitoringInterval = null;
    static dormancyCheckInterval = null;
    static capitalTrackingInterval = null;
    /**
     ...
     */
    static startDailyReconciliation() {
        ...
        const runCapitalTracking = async () => {
            try {
                ...
                try {
                    ...
                    const totalFloat = floatRows[0] ? Number(floatRows[0].total_float) : 0;
                    const totalLiquidity = agentsRows[0] ? Number(agentsRows[0].total_liquidity) : 0;
                    cashFromDb = totalFloat + totalLiquidity;
                }
                catch (e) {
                    logError('Capital tracking: failed to read liquid assets from DB', e);
                }
...
//# sourceMappingURL=complianceScheduler.js.map