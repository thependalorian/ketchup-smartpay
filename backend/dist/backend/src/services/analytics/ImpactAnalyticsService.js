      ...
      `;
            ...
            return {
                ...
                socialImpact: {
                    ...
                    ruralPercent: Number(u.total) ? (Number(rural.c) / Number(u.total)) * 100 : 0,
                    femalePercent: Number(u.total) ? (Number(female.c) / Number(u.total)) * 100 : 0,
                },
...
//# sourceMappingURL=ImpactAnalyticsService.js.map