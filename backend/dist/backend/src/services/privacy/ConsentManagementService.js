...
export class ConsentManagementService {
    async getConsents(beneficiaryId) {
        try {
    ...
    async grantConsent(beneficiaryId, consentType, version) {
        try {
            await sql `
    ...
    async withdrawConsent(beneficiaryId, consentType) {
        try {
            await sql `
...
//# sourceMappingURL=ConsentManagementService.js.map