...
export class VoucherService {
    ...
    constructor(generator, repository, beneficiaryRepository) {
    ...
    async issueVoucher(data) {
        try {
            ...
            const voucher = this.generator.createVoucher(d, beneficiary.name, beneficiary.region);
            // Save to database
     ...
     */
    async updateStatus(id, status, redemptionMethod) {
        try {
     ...
     */
    async reissue(oldVoucherId, options) {
