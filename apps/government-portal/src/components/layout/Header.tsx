 ...
 * 
 * Purpose: Top navigation bar for Government oversight portal with mobile responsive design
 * Location: apps/government-portal/src/components/layout/Header.tsx
 */

import { motion } from 'framer-motion';
import { Bell, Search, User, Shield, Menu } from 'lucide-react';
  ...
  return (
    <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-border bg-background/95 px-4 md:px-6 backdrop-blur-sm shadow-sm">
      ...
      <div className="flex items-center gap-2 md:gap-4">
        {/* Government Badge - hidden on mobile, visible on md and up */}
