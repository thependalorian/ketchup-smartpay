"""
Scout Agent - LLM Provider Configuration
"""
...
def get_llm_model() -> OpenAIModel:
    """Get LLM model configuration for Scout Agent"""
    provider = os.getenv("SCOUT_LLM_PROVIDER", "deepseek")  # Default to deepseek
...
# Model config for Scout Agent tasks
SCOUT_MODEL_CONFIG = {
    "market_analysis": {
        "temperature": 0.2,  # More deterministic for data analysis
        "max_tokens": 2000
    },
    "forecasting": {
        "temperature": 0.1,  # Very deterministic for forecasts
        "max_tokens": 1500
    },
    "search_summary": {
        "temperature": 0.3,
