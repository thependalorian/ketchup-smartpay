"""
Transaction Analyst Agent - LLM Provider Configuration
"""
...
def get_llm_model() -> OpenAIModel:
    """
    Get LLM model configuration for Transaction Analyst Agent
    
    Uses DeepSeek only (no OpenAI or Anthropic models).
    """
    provider = os.getenv("TRANSACTION_ANALYST_LLM_PROVIDER", "deepseek")
