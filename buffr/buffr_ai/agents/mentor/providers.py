"""
Mentor Agent - LLM Provider Configuration
"""
...
def get_llm_model() -> OpenAIModel:
    """Get LLM model configuration for Mentor Agent"""
    provider = os.getenv("MENTOR_LLM_PROVIDER", "deepseek")  # Default to deepseek
