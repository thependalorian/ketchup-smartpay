 ...
 * 
 * Location: scripts/run-analytics-migration.ts
 * Purpose: Execute analytics database schema migration
 * 
 * Usage: npx tsx scripts/run-analytics-migration.ts
 */
...
async function runMigration() {
  ...
  try {
    // Read migration file
    const migrationPath = resolve(process.cwd(), 'sql/migration_analytics.sql');
