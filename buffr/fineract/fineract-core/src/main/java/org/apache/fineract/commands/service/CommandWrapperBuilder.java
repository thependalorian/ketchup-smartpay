...
public class CommandWrapperBuilder {
    ...
    // ============================================================================
    // VOUCHER COMMANDS (fineract-voucher module)
    // ============================================================================
    ...
    public CommandWrapperBuilder createVoucherProduct() {
        this.actionName = "CREATE";
        this.entityName = "VOUCHERPRODUCT";
        this.entityId = null;
        this.href = "/voucherproducts";
        return this;
    }

    public CommandWrapperBuilder updateVoucherProduct(final Long productId) {
        this.actionName = "UPDATE";
        this.entityName = "VOUCHERPRODUCT";
        this.entityId = productId;
        this.href = "/voucherproducts/" + productId;
        return this;
    }

    // ============================================================================
    // WALLET COMMANDS (fineract-wallets module)
    // ============================================================================

    public CommandWrapperBuilder createWallet() {
        this.actionName = "CREATE";
    ...
    public CommandWrapperBuilder createWalletProduct() {
        this.actionName = "CREATE";
        this.entityName = "WALLETPRODUCT";
        this.entityId = null;
        this.href = "/walletproducts";
        return this;
    }
}
