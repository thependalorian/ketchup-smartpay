/**
 * Open Banking API: /api/v1/ussd/voucher-redeem
 * 
 * USSD voucher redemption (Open Banking format)
 * 
...
async function handleVoucherRedeem(req: ExpoRequest) {
  ...
  try {
    ...
    const { SessionId, PhoneNumber, VoucherId, PIN, RedemptionMethod } = Data;
    ...
    const redeemResponse = {
      ...
      Links: {
        Self: '/api/v1/ussd/voucher-redeem',
      },
      Meta: {},
    };
